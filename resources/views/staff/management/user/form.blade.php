                    ...
                    <div class="col-md-offset-2 col-md-8">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-body">
                                <form method="POST"
                                      action="{{ isset($user) ? route('Staff::Management::user@update', [$user->id] ): route('Staff::Management::user@store') }}">
                                    {{ csrf_field() }}
                                    @if (isset($user))
                                ...
                                <!---------- Name------------>
                                    ...
                                    <div class="form-group {{ $errors->has('password_confirmation') ? 'has-error has-feedback' : '' }}">
                                        <label for="password-confirmation" class="control-label text-semibold">Xác nhận
                                            Mật khẩu</label>
                                        <i class="icon-question4 text-muted text-size-mini cursor-pointer js-help-icon"
                                                            ...
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" id="" name="role[]"
                                                                           value="{{$row->id}}"
                                                                           {{ isset($userRoles[$row->id]) ? ' checked="checked"' : ''  }}  class="js-checkbox">
                                                                </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr role="row" id="">
                                                        ...
                                                        <td>
                                                            <div class="radio">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="status[{{$row->id}}]"
                                                                           {{ (isset($userPermissions[$row->id]) and $userPermissions[$row->id]->pivot->value == 0) ? ' checked="checked"' : ''  }} class="js-radio"
                                                                           value="0">
                                                                </label>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="radio">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="status[{{$row->id}}]"
                                                                           {{ (isset($userPermissions[$row->id]) and $userPermissions[$row->id]->pivot->value == 1) ? ' checked="checked"' : ''  }} class="js-radio"
                                                                           value="1">
                                                                </label>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="radio">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="status[{{$row->id}}]"
                                                                           {{ (isset($userPermissions[$row->id]) and $userPermissions[$row->id]->pivot->value == 2) ? ' checked="checked"' : ''  }} class="js-radio"
                                                                           value="2">
                                                                </label>
                                                            </div>
                                                        </td>
