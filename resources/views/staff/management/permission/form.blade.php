          ...
          <div class="col-md-offset-2 col-md-8">
            ...
            <div class="panel panel-flat">
              <div class="panel-body">
                <form method="POST" enctype="multipart/form-data" action="{{ isset($permission) ? route('Staff::Management::permission@update', [$permission->id] ): route('Staff::Management::permission@store') }}">
                  {{ csrf_field() }}
                  @if (isset($permission))
