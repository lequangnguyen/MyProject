...
$(function() {    
    ...
    function trafficSources(element, height) {
        ...
        d3.csv("assets/demo_data/dashboard/traffic_sources.csv", function (error, data) {
            ...
            // Horizontal grid. Must be before the role
            svg.append("g")
            ...
            var group = svg.append('g')
                .attr('class', 'streamgraph-layers-role');

            // And append paths to this role
            ...
            // Append role to the role of paths to prevent appearance outside chart area
            ...
            // Append events to the layers role
            // ------------------------------
    ...
    function appSalesLines(element, height) {
        ...
        function redraw() { 
            ...
            // Append a role tag for each line
            var lineGroup = lines
                .enter()
                .append("g")
                    .attr("class", "lines")
    ...
    function salesHeatmap() {
        ...
        d3.csv("assets/demo_data/dashboard/app_sales_heatmap.csv", function(error, data) {
            ...
            var hourGroup = svg.selectAll('.hour-role')
                .data(nest)
                .enter()
                .append('g')
                    .attr('class', 'hour-role')
